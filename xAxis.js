...
svg.append('g').attr('class','axisY').call(yAxis).attr("transform","translate(30,30)")

svg.selectAll('.axisY').append('path').attr('d',area(dataArray)).attr("fill","none").attr("stroke","blue");
